  ...
  return (
    <div className="flex justify-evenly flex-wrap items-center py-10 px-10">
      {detail?.map((items, i) => (
        ...
        <Link href={`/pujaServices/${items.name}`} key={i}>
                     <div key={i}
              className="w-80 h-196 rounded-xl border border-grey-800 my-5 bg-secondary">
            ...
            <div className=" h-20 bg-primary w-full rounded-b-lg text-secondary p-3 flex items-center justify-center text-center">
